...
my $sample_full_path = "";
my $sample_name = "";
my $JOB_QUEUE = "research-hpc";
my $JOB_DOCKER_IMAGE = "'docker(lbwang/mgi:debian-perl)'";
my $JOB_GROUP = "/lwang/cptac_germline_variant_call";
...
sub bsub_gatk{
    ...
    print GATK "#!/bin/bash\n";
    print GATK "#BSUB -n 1\n";
    print GATK "#BSUB -a $JOB_DOCKER_IMAGE \n";
    print GATK "#BSUB -q $JOB_QUEUE \n";
    print GATK "#BSUB -g $JOB_GROUP \n";
...
sub bsub_varscan{
    ...
    print VARSCAN "#BSUB -a $JOB_DOCKER_IMAGE \n";
    print VARSCAN "#BSUB -q $JOB_QUEUE \n";
    print VARSCAN "#BSUB -g $JOB_GROUP \n";
...
sub bsub_pindel{
    ...
    print PINDEL "#BSUB -a $JOB_DOCKER_IMAGE \n";
    print PINDEL "#BSUB -q $JOB_QUEUE \n";
    print PINDEL "#BSUB -g $JOB_GROUP \n";
