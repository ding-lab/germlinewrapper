...
sub bsub_run_vep2 {
    ...
    print VEP2 "ROI_fixed_nWT_sorted=".$sample_full_path."/".$sample_name.".sorted.charg.vcf","\n"; 
    print VEP2 "ROI_fixed_nWT_sorted_gz=".$sample_full_path."/".$sample_name.".sorted.charg.vcf.gz","\n"; 
